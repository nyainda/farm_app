    ...
    <div class="flex font-serif mx-4 mt-4 items-center">
        ...
        <div class="ml-auto font-serif">
            <div class="relative font-serif inline-block text-left">
                ...
                <a href="{{ route('treat.treatment', ['animal_id' => $animal->id]) }}" class="block px-4 py-2 dark:text-gray-100 text-sm text-gray-700 hover:bg-blue-500 dark:hover:bg-gray-600 add-treatment" role="menuitem">
                ...
                <a href="{{ route('Sale.display', ['animal_id' => $animal->id]) }}" class="block px-4 py-2 text-sm dark:text-gray-100 text-gray-700 hover:bg-blue-500 dark:hover:bg-gray-600 sell-animal" role="menuitem">

<x-app-layout title="bill-of-sale">
    <div id="bill-of-sale-content" class="container mx-auto mt-8 p-4 dark:bg-gray-700 mb-4 font-serif bg-white rounded-lg shadow-lg">
        ...
        <form action="{{ route('AnimalContent.storeBillOfSale', ['animal_id' => $animal->id]) }}" method="POST">
            @csrf
        ...
        <table class="w-full mt-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input type="text" name="address-1" class="w-full mb-4 dark:text-gray-200 p-2 dark:bg-gray-700 border border-gray-300 rounded-md" value="">
                    </td>
                    <td class="dark:text-gray-200 font-medium">Address:</td>
                    <td colspan="3">
                        <input type="text" name="address-2" class="w-full mb-4 dark:text-gray-200 dark:bg-gray-700 p-2 border border-gray-300 rounded-md" value="">
                    </td>
                </tr>
                <tr>
                    <td class="dark:text-gray-200 font-medium">City:</td>
                    <td colspan="3">
                        <input type="text" name="city-1" class="w-full dark:text-gray-200 p-2 mt-4 dark:bg-gray-700 border border-gray-300 rounded-md" value="">
                    </td>
                    <td class="dark:text-gray-200 font-medium">City:</td>
                    <td colspan="3">
                        <input type="text" name="city-2" class="w-full  dark:text-gray-200  p-2 mb-4  dark:bg-gray-700 border border-gray-300 rounded-md" value="">
                    </td>
                </tr>
                <tr>
                    <td class="dark:text-gray-200 font-medium">Email:</td>
                    <td colspan="3">
                        <input type="text" name="email-1" class="w-full dark:text-gray-200 p-2 mt-4 dark:bg-gray-700 border border-gray-300 rounded-md" value="">
                    </td>
                    <td class="dark:text-gray-200 font-medium">Email:</td>
                    <td colspan="3">
                        <input type="text" name="email-2" class="w-full p-2 dark:text-gray-200 mt-4 dark:bg-gray-700 border border-gray-300 rounded-md" value="">
                    </td>
                </tr>
        ...
        <div class="mt-8">
            <p class="dark:text-gray-200 mb-2">Signature of Seller <input type="text" name="sign-seller" class="w-1/3 border dark:text-gray-200  dark:bg-gray-700 border-gray-300 rounded-md p-2" value=""> Date: <input type="text" class="w-1/3 border border-gray-300 dark:bg-gray-700 rounded-md p-2" value=""></p>
            <p class="dark:text-gray-200 mb-2">Signature of Buyer <input type="text" name="sign-buyer" class="w-1/3 dark:text-gray-200  dark:bg-gray-700 border border-gray-300 rounded-md p-2" value=""> Date: <input type="text" class="w-1/3 mt-4 border border-gray-300 dark:bg-gray-700 rounded-md p-2" value=""></p>
        </div>
    </div>

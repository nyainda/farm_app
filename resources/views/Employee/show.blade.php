    ...
    <div class="container mx-auto p-6 space-y-6">
        ...
        <div class="mb-4 flex flex-col font-serif sm:flex-row justify-between items-center">
            <div class="mb-2 sm:mb-0">
                <a class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600 font-serif  transition duration-300 ease-in-out" data-remote="true" href="{{ route('Employee.create', ['animal_id' => $animal->id]) }}">New employees</a>
            </div>
            <div class="sm:ml-2">
        ...
        <div class="bg-white dark:bg-gray-700 rounded-lg shadow-md p-6 mb-6">
            <div class="flex flex-row justify-between items-center mb-4 font-serif">
                <a class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-md transition duration-300 ease-in-out" data-remote="true" href="{{ route('Employee.create', ['animal_id' => $animal->id]) }}">New Contact Record</a>
...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
       ...
       {{--}} <caption class="p-5 text-lg font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                <td class="px-6 py-4">
                    <input type="checkbox" class=" dark:bg-gray-700 dark:text-gray-400" name="employee_ids[]" value="{{ $employee->id }}">
                </td>
                ...
                <td class="px-6 font-serif py-4">
                    {{$employee->identifier?: 'N/A'}}

                </td>

                <td class="px-6 font-serif py-4">
                    <a href="{{ route('Employee.employeeedit', ['animal_id' => $animal->id, 'employee_id' => $employee->id]) }}" class="font-medium font-serif text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                    <a href="{{ route('Employee.delete', ['animal_id' => $animal->id, 'employee_id' => $employee->id]) }}" class="font-medium text-red-600 font-serif dark:text-red-500 hover:underline">Delete</a>
        ...
        <div id="animals" class="p-4  mx-8">
            <div class="content-wrapper font-serif dark:bg-gray-700 nothing mt-4 bg-gray-100 rounded-md p-4">
                ...
                <div class="text-center dark:text-gray-200 font-serif text-gray-600 mt-2">
                    Add a new employees and they'll show up here.
                </div>
    ...
    <p class="mb-4 text-gray-600 font-serif text-center dark:text-gray-400"> Displaying all <span class="text-red-500 font-serif ">{{ count($employees) }}</span> records</p>
</x-app-layout>
<script>
...
<script>
    function batchDelete() {
        var checkboxes = document.querySelectorAll('input[name="employee_ids[]"]:checked');
        ...
        if (confirm("Are you sure you want to delete the selected items?")) {
            ...
            form.setAttribute('action', '{{ route("employees.batchDelete") }}');

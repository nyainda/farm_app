            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
              ...
              <li aria-current="page">
                <div class="flex items-center">
                  ...
                  <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">BillOfSale</span>
                </div>
              </li>
            </ol>
          </nav>
    ...
    <div class="container mx-auto p-6 space-y-6">
        ...
        <div class="mb-4 flex flex-col font-serif sm:flex-row justify-between items-center">
            <div class="mb-2 sm:mb-0">
                <a class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600  font-serif transition duration-300 ease-in-out" data-remote="true" href="#">New BillOfSale Record</a>
            </div>
            <div class="sm:ml-2">
...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    <table class="w-full font-serif  text-sm text-left text-gray-500 dark:text-gray-400">
       {{--}} <caption class="p-5 text-lg font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
            <div class="mb-4 flex flex-col font-serif sm:flex-row justify-between items-center">
                <div class="mb-2 sm:mb-0">
                    <a class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600 transition duration-300 ease-in-out" data-remote="true" href="{{ route('animals.BillOfSale', ['animal_id' => $animal->id]) }}">New BillOfSale Record</a>
                </div>
                <div class="sm:ml-2">
                    <button id="printButton" class="btn btn-default hidden sm:inline-block" title="Print">
                        <i class="fas fa-print" aria-hidden="true"></i> Print
        ...
        <tbody>
            ...
            <tr class="bg-white border-b  font-serif dark:bg-gray-800 dark:border-gray-700">
                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    {{  $BillOfSale->address-1 ?: 'N/A'}}
                </th>
                <td class="px-6 font-serif  py-4">

                    {{  $BillOfSale->amount ?: 'N/A'}}/  <span class="text-red-500">{{  $BillOfSale->unit}}</span>


                </td>
                <td class="px-6 py-4">

                    {{  $BillOfSale->estimated_cost ?: 'N/A'}}/ <span class="text-red-500">{{$BillOfSale->BillOfSale_currency ?: 'N/A'}}</span>


                </td>
                <td class="px-6 py-4">
                    {{  $BillOfSale->feed_details ?: 'N/A'}}
                </td>
                <td class="px-6 py-4">

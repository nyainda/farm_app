    ...
    <div class="container mx-auto p-6 space-y-6">
        ...
        <div class="mb-4 flex flex-col font-serif sm:flex-row justify-between items-center">
            <div class="mb-2 sm:mb-0">
                <a class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600  font-serif transition duration-300 ease-in-out" data-remote="true" href="{{ route('animals.contact', ['animal_id' => $animal->id]) }}">New contact Record</a>
            </div>
            <div class="sm:ml-2">
       ...
       {{--}} <caption class="p-5 text-lg font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b  font-serif dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                    {{ $contact->primary_phone ? '+254 ' . substr($contact->primary_phone, 0, 5) . '*****' . substr($contact->primary_phone, -2) : 'N/A' }}
                </td>
                ...
                <td class="px-6 py-4">
                    <a href="{{ route('animals.contactedit', ['animal_id' => $animal->id, 'contact_id' => $contact->id]) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>

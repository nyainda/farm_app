<x-app-layout title="Cards">
    ...
    <div class="container font-serif mx-auto mt-8 p-4 mb-4 bg-gray-100 dark:bg-gray-700 dark:rounded-lg rounded-lg shadow-lg">
        ...
        <div class="flex flex-col">
            ...
            <input type="date" id="last_vet_visit" value="{{$health->last_vet_visit}}" name="last_vet_visit" class="border-2 dark:text-gray-200  dark:bg-gray-800 border-gray-200 p-2 rounded-md">
        </div>
        ...
        <div class="flex flex-col">
            ...
            <input type="text" id="exercise_requirements" value="{{$health->exercise_requirements}}" name="exercise_requirements" class="border-2 dark:text-gray-200  dark:bg-gray-800 border-gray-200 p-2 rounded-md">
        </div>

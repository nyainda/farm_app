    ...
    <div class="container mx-auto p-6 space-y-6">
        ...
        <div class="mb-4 flex flex-col font-serif sm:flex-row justify-between items-center">
            <div class="mb-2 sm:mb-0">
                <a class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600 transition duration-300 ease-in-out" data-remote="true" href="{{ route('Measurement.measurement', ['animal_id' => $animal->id]) }}">New measurement Record</a>
            </div>
            <div class="sm:ml-2">
...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
       ...
       {{--}} <caption class="p-5 text-lg font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
        ...
        <tbody>
            ...
            <tr class="bg-white font-serif  border-b dark:bg-gray-800 dark:border-gray-700">
                <td class="px-6 py-4">
                    <input type="checkbox" class=" dark:bg-gray-700 dark:text-gray-400" name="measurement_ids[]" value="{{ $measurement->id }}">
                </td>
    ...
    {{ $measurement->temp ?: 'N/A'}}
                ...
                <td td class="px-6 py-4">
                    <a href="{{ route('Measurement.measurementedit', ['animal_id' => $animal->id, 'measurement_id' => $measurement->id]) }}" class="text-blue-600 hover:underline mr-2 print-hidden">Edit</a>
...
<script>
    function batchDelete() {
        var checkboxes = document.querySelectorAll('input[name="measurement_ids[]"]:checked');
        ...
        if (confirm("Are you sure you want to delete the selected items?")) {
            ...
            form.setAttribute('action', '{{ route("measurement.batchDelete") }}');

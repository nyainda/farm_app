    ...
    <div class="container font-serif mx-auto mt-8 p-4 mb-4 bg-gray-100 dark:bg-gray-700 dark:rounded-lg rounded-lg shadow-lg">
        ...
        <form action="{{ route('task.update', ['animal_id' => $animal->id, 'task_id' => $task->id]) }}" method="POST" class="grid grid-cols-2 gap-4"   >
            ...
            <div class="col-span-2">
                ...
                <input type="text" id="title" value="{{$task->title}}" name="title" class="form-input dark:text-gray-200 dark:bg-gray-700 w-full" required>
            </div>

            <div>
                <label for="startDate" class="block dark:text-gray-200 text-gray-600">Start Date</label>
                <input type="date" id="startDate" value="{{$task->start_date}}" name="start_date" class="form-input dark:text-gray-200 dark:bg-gray-700   w-full">
            </div>
            <div>
                <label for="startTime" class="block dark:text-gray-200 text-gray-600">Start Time</label>
                <div class="flex space-x-2">

                    <select id="startHour" value="{{$task->start_hour}}" name="start_hour" class="form-select dark:text-gray-200 dark:bg-gray-700 w-1/2">
                    ...
                    <input type="number" value="{{$task->start_minute}}" id="startMinute" name="start_minute" class="form-input dark:text-gray-200 dark:bg-gray-700 w-1/2" min="0" max="59" placeholder="MM">
            ...
            <div>
                ...
                <div class="flex space-x-2">
                   {{-- <input type="number" id="endHour" name="end_hour" class="form-input dark:text-gray-200 dark:bg-gray-700 w-1/2" min="0" max="23" placeholder="HH">--}}
                    ...
                    <select id="endHour" value="{{$task->end_hour}}" name="end_hour" class="form-select dark:text-gray-200 dark:bg-gray-700 w-1/2">
                        <option value="1">1 AM</option>
                        <option value="2">2 AM</option>
                        <option value="3">3 AM</option>
                        <option value="4">4 AM</option>
...
<option value="lowest">Lowest</option></select>
            ...
            <div class="col-span-2">
                ...
                <textarea id="description" value="{{$task->description}}" name="description" class="form-textarea dark:text-gray-200 dark:bg-gray-700   w-full" rows="3"></textarea>
            </div>
            ...
            <div class="col-span-2">
                ...
                <input type="text" id="associatedTo" value="{{$task->associated_to}}"   name="associated_to" class="form-input dark:text-gray-200 dark:bg-gray-700 w-full" >
            </div>
...
<div class="flex col-span-2 justify-end mt-6">
    <button type="button" class="px-3 py-2 text-sm mr-4 mb-4 dark:text-gray-100  tracking-wide text-white capitalize transition-colors duration-200 transform bg-red-500 rounded-md dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:bg-indigo-700 hover:bg-indigo-600 focus:outline-none focus:bg-indigo-500 focus:ring focus:ring-indigo-300 focus:ring-opacity-50">
        ...
        <a href="{{ route('Tasks.showtask', ['animal_id' => $animal->id]) }}" class="btn btn-gray-500">Cancel</a>
    </button>

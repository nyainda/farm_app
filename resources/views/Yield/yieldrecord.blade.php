<x-app-layout title="Yield Record">
    <form action="{{ route('Yield.storeyieldrecord', ['animal_id' => $animal->id]) }}" method="POST">
        @csrf
    <div class="container grid font-serif gap-4 dark:text-gray-200 grid-cols-2 mx-auto mt-8 p-4 mb-4 bg-gray-20 dark:bg-gray-700 dark:rounded-lg shadow-lg">
        <h2 class="text-2xl font-serif  font-semibold col-span-2">YieldRecord For {{$animal->type}} </h2>
...
<option value="foliage">Foliage</option>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="trace_number" name="trace_number" class="w-full dark:bg-gray-700 dark:text-gray-200  px-3 py-2 border rounded shadow-sm focus:outline-none focus:border-blue-500" placeholder="N/B Trace Number will be generated outomatically " disabled>
        </div>

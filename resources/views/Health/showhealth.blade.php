       ...
       {{--}} <caption class="p-5 text-lg font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                <td class="px-6 py-4">
                    <input type="checkbox" class=" dark:bg-gray-700 dark:text-gray-400" name="feeding_ids[]" value="{{$health->id }}">
                </td>
                ...
                <td class="px-6 py-4">
                    <div class="flex space-x-2 items-center">
                        <a href="{{ route('Health.healthedit', ['animal_id' => $animal->id, 'health_id' => $health->id]) }}" class="inline-flex items-center px-2.5 py-1.5 bg-green-100 text-green-800 rounded-md hover:bg-green-200 transition duration-300 dark:bg-green-900 dark:text-green-300 dark:hover:bg-green-800">
                        ...
                        <div class="flex ">
                            <a href="{{ route('health.delete', ['animal_id' => $animal->id, 'health_id' => $health->id]) }}" class="inline-flex items-center px-2.5 py-1.5 bg-red-100 text-red-800 rounded-md hover:bg-red-200 transition duration-300 dark:bg-red-900 dark:text-red-300 dark:hover:bg-red-800">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<script>
    function batchDelete() {
        ...
        if (confirm("Are you sure you want to delete the selected items?")) {
            ...
            form.setAttribute('action', '{{ route("healths.batchDelete") }}');

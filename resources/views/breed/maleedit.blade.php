...
<div class="mb-4">
    ...
    <textarea  name="breeding_history" value="{{$breeding->breeding_history}}" id="breeding_history" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full"></textarea>
</div>

<!-- Breeding Date -->
<div class="mb-4">
    <label for="genetic_details" class="block text-sm dark:text-gray-200 font-medium text-gray-600">Genetic_details</label>
    <textarea name="genetic_details" value="{{$breeding->genetic_details}}" id="genetic_details" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full"></textarea>
</div>
...
<div class="mb-4">
    ...
    <textarea value="{{$breeding->breeding_recommendations}}" name="breeding_recommendations" id="breeding_recommendations" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full"></textarea>
</div>
...
<div class="mb-4">
    ...
    <textarea value="{{$breeding->future_breeding_plans}}" name="future_breeding_plans" id="future_breeding_plans" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full"></textarea>
</div>

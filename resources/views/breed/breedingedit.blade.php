...
<x-app-layout title="breeding">
    <div class="container font-serif mx-auto mt-8 p-4 mb-8 bg-white dark:bg-gray-700 dark:rounded-lg dark:shadow-lg">
        <div class="flex items-center justify-between p-4 mb-4 rounded-lg">
            <h1 class="text-2xl dark:text-white font-semibold">Edit <span  class="text-blue-400">{{$animal->type}} </span> Record</h1>
            <span class="px-3 py-1 text-sm text-blue-400 bg-gray-600 rounded-full">{{$animal->internal_id}}</span>
          </div>

        <hr class="mb-4">
        @if(strtolower($animal->gender) === 'male')
        @include('breed.maleedit')
@else
<form action="{{ route('breed.update', ['animal_id' => $animal->id, 'breeding_id' => $breeding->id]) }}" method="POST"   >
    @csrf <!-- Add CSRF token -->
    @method('PUT')
...
<option value="{{$animal->type}}">{{$animal->type}}</option>
            ...
            <div class="flex col-span-2 justify-end mt-6">
                <button type="button" class="px-3 py-2 text-sm mr-4 mb-4 dark:text-gray-100 tracking-wide text-white capitalize transition-colors duration-200 transform bg-red-500 rounded-md dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:bg-indigo-700 hover:bg-indigo-600 focus:outline-none focus:bg-indigo-500 focus:ring focus:ring-indigo-300 focus:ring-opacity-50">
                    <a href="{{ route('breed.showbreeding', ['animal_id' => $animal->id, 'breeding_id' => $breeding->id]) }}" class="btn btn-gray-500">Cancel</a>
    ...
    <div class="mb-4">
        ...
        <input
            ...
            class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 dark:focus:ring-indigo-600 dark:focus:border-indigo-600"
            value="{{ $breeding->egg_laying_start_date }}"
        />
    </div>
    ...
    <div class="mb-4">
        ...
        <input
            ...
            class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 dark:focus:ring-indigo-600 dark:focus:border-indigo-600"
            value="{{ $breeding->egg_laying_end_date }}"
        />
    </div>
...
<div class="mb-4">
    ...
    <input
        ...
        class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 dark:focus:ring-indigo-600 dark:focus:border-indigo-600"
        placeholder="{{ $breeding->period_day }}"
    />
</div>
...
<div class="mb-4">
    ...
    <input
        ...
        id="nesting_material"
        class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 dark:focus:ring-indigo-600 dark:focus:border-indigo-600"
        placeholder="{{ $breeding->nesting_material }}"
    />
</div>
...
<div class="mb-4">
    ...
    <option>Natural</option>
      ...
      <option>Both</option>
        <option>{{ $breeding->light_condition }}</option>
    </select>
</div>
...
<div class="mb-4">
    ...
    <input
        ...
        id="number_of_chicks"
        class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 dark:focus:ring-indigo-600 dark:focus:border-indigo-600"
        placeholder="{{ $breeding->number_of_chicks }}"
    />
</div>
...
<!-- Number of Chicks -->
<div class="mb-4">
    <label for="chick_count" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Number of Chicks</label>
    <input
        type="number"
        name="number_of_chicks"
      id="number_of_chicks"
...
<div class="mb-4">
    ...
    <textarea
        ...
        class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 dark:focus:ring-indigo-600 dark:focus:border-indigo-600"
        value="{{ $breeding->environmental_conditions }}"
    ></textarea>
</div>
</div>
                ...
                <input type="date" value="{{$breeding->date_of_breeding}}" name="date_of_breeding" id="date_of_breeding" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>
                <div class="mb-4">
                <label for="temperature" class="block text-sm font-medium dark:text-gray-200 text-gray-600">Water Temperature(°C)</label>

                <input type="number" value="{{$breeding->temp}}" name="temp" id="temp" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>
            <div class="mb-4">
                <label for="water_ph" class="block text-sm font-medium dark:text-gray-200 text-gray-600">Water pH{0-14}</label>

                <input type="number" value="{{$breeding->water_ph}}" name="water_ph" id="water_ph" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>
            <div class="mb-4">
                <label for="tank_size" class="block text-sm font-medium dark:text-gray-200 text-gray-600">tank/pond size</label>

                <input type="number" value="{{$breeding->tank_size}}" name="tank_size" id="tank_size" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>
            <div class="mb-4">
    ...
    <select name="spawning_behavior" id="spawning_behavior" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
        <option value="{{$breeding->spawning_behavior}}">{{$breeding->spawning_behavior}}</option>
...
<div class="mb-4">
    ...
    <input type="number" value="{{$breeding->no_eggs}}" id="breeding_fish" name="no_eggs" min="0" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
</div>
<div class="mb-4">
    ...
    <input type="text" value="{{$breeding->tankSize}}" id="breeding_fish_size" name="tankSize" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
</div>
...
<div class="mb-4">
    ...
    <select id="breeding_fish_color" name="color" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
        <option value="{{$breeding->color}}">{{$breeding->color}}</option>
...
<div class="mb-4">
    ...
    <select name="spawning_substrate" id="spawning_substrate" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
        <option value="{{$breeding->spawning_substrate}}" class="text-red-500">{{$breeding->spawning_substrate}}</option>
...
<div class="mb-4">
    ...
    <select name="fry_feeding" id="fry_feeding" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
        <option value="{{$breeding->fry_feeding}}">{{$breeding->fry_feeding}}</option>
        ...
        <!-- Add more fry feeding options as needed -->
            ...
            <div class="mb-4">
                ...
                <input type="text" value="{{$breeding->fry_tank_setup}}" name="fry_tank_setup" id="fry_tank_setup" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>
            <div class="mb-4">
    ...
    <select name="water_quality_monitoring" id="water_quality_monitoring" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
        <option value="{{$breeding->water_quality_monitoring}}">{{$breeding->water_quality_monitoring}}</option>
        ...
        <input type="text"  name="enclosure_type" id="enclosure_type" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            ...
            <div class="mb-4">
                ...
                <input type="number" value="{{$breeding->temp}}" name="temp" id="heat_date" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>
            <div class="mb-4">
                <label for="humidity" class="block text-sm font-medium dark:text-gray-200 text-gray-600">Humidity (%)</label>
                <input type="number" value="{{$breeding->humidity}}" name="humidity" id="humidity" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>
            <div class="mb-4">
                <label for="light_condition" class="block text-sm font-medium dark:text-gray-200 text-gray-600">Light Conditions</label>
                <input type="text" value="{{$breeding->light_condition}}" name="light_condition" id="heat_date" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>

            <div class="mb-4">
                <label for="egg_stage" class="block text-sm  dark:text-gray-200 font-medium text-gray-600">Duration of Egg Stage</label>
                <input type="number" value="{{$breeding->egg_stage}}" name="egg_stage" id="egg_stage" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>
            <div class="mb-4">
                <label for="pupal_stage" class="block text-sm  dark:text-gray-200 font-medium text-gray-600">Duration of Pupal Stage</label>
                <input type="number" value="{{$breeding->pupal_stage}}" name="pupal_stage" id="pupal_stage" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>
            <div class="mb-4">
                <label for="adult_stage" class="block text-sm  dark:text-gray-200 font-medium text-gray-600">Duration of Adult Stage</label>
                <input type="number" value="{{$breeding->adult_stage}}" name="adult_stage" id="adult_stage" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>
            <div class="mb-4">
                <label for="nesting_material" class="block text-sm dark:text-gray-200 font-medium text-gray-600">Monitoring Tools Used</label>
                <input type="text" value="{{$breeding->nesting_material}}" name="nesting_material" id="nesting_material" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>
            <div class="mb-4">
                ...
                <textarea value="{{$breeding->environmental_conditions}}" name="environmental_conditions" id="environmental_conditions" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full"></textarea>
            </div>
            </div>
                `;
                ...
                <input type="date" value="{{$breeding->heat_date}}" name="heat_date" id="heat_date" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>

            <!-- Breeding Date -->
            <div class="mb-4">
                <label for="breeding_date" class="block text-sm dark:text-gray-200 font-medium text-gray-600">Breeding Date</label>
                <input type="date" value="{{$breeding->breeding_date}}" name="breeding_date" id="breeding_date" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>

            <!-- Due Date -->
            <div class="mb-4">
                <label for="due_date" class="block text-sm font-medium dark:text-gray-200 text-gray-600">Due Date</label>
                <input type="date" value="{{$breeding->due_date}}" name="due_date" id="due_date" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>
            <div class="mb-4">
                <label for="age" class="block text-sm  dark:text-gray-200 font-medium text-gray-600">Age</label>
                <input type="number" value="{{$breeding->age}}" name="age" id="age" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>
            <div class="mb-4">
                <label for="height" class="block text-sm  dark:text-gray-200 font-medium text-gray-600">Height</label>
                <input type="number" value={{$breeding->height}} name="height" id="height" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>

            <div>
                <label for="color" class="block text-sm  dark:text-gray-200 font-medium text-gray-600">Color</label>
                <input type="text" name="color" id="color" value="{{$breeding->color}}"
            ...
            <div class="mb-4">
                ...
                <input type="number" value="{{$breeding->weight}}" name="weight" id="weight" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>
            <!-- Pregnancy Status -->
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="number" value="{{$breeding->offspring_count}}" name="offspring_count" id="offspring_count" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>

            <!-- Offspring IDs -->
            <div class="mb-4">
                <label for="offspring_ids" class="block text-sm  dark:text-gray-200 font-medium text-gray-600">Offspring IDs</label>
                <input type="text" value="{{$breeding->offspring_ids}}" name="offspring_ids" id="offspring_ids" class="mt-1 dark:text-gray-200 dark:bg-gray-800 p-2 border rounded-md w-full">
            </div>
            </div>
                `;
    ...
    <div>
        ...
        <input type="text" value="{{$breeding->species}}" name="species" id="species"
    ...
    <div>
        ...
        <select name="habitat" id="habitat" class="mt-1 dark:text-gray-200 focus:ring-indigo-500 dark:bg-gray-800 p-2 border  dark:bg-gray-800 dark:border-gray-600 dark:focus:ring-indigo-500 dark:focus:border-indigo-500 rounded-md w-full">
            <option value="{{$breeding->habitat}}">{{$breeding->habitat}}</option>
    ...
    <div>
        ...
        <input type="number" value="{{$breeding->temp}}" name="temp" id="temperature"
            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:bg-gray-800 dark:border-gray-600 dark:focus:ring-indigo-500 dark:focus:border-indigo-500">
    </div>
    <div>
        <label for="humidity" class="block text-sm font-medium">Humidity (%)</label>
        <input type="number" value="{{$breeding->humidity}}" name="humidity" id="humidity"
            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:bg-gray-800 dark:border-gray-600 dark:focus:ring-indigo-500 dark:focus:border-indigo-500">
    </div>
    <div>
        <label for="tankSize" class="block text-sm font-medium">Tank Size (in liters)</label>
        <input type="number" value="{{$breeding->tankSize}}" name="tankSize" id="tankSize"
            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:bg-gray-800 dark:border-gray-600 dark:focus:ring-indigo-500 dark:focus:border-indigo-500">
    </div>
    <div>
        <label for="feedingSchedule" class="block text-sm font-medium">Feeding Schedule</label>
        <input type="text" value="{{$breeding->feedingSchedule}}" name="feedingSchedule" id="feedingSchedule"
            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:bg-gray-800 dark:border-gray-600 dark:focus:ring-indigo-500 dark:focus:border-indigo-500">
    </div>
    <div>
        <label for="healthCondition" class="block text-sm font-medium">Health Condition</label>
        <input type="text" value="{{$breeding->healthCondition}}" name="healthCondition" id="healthCondition"
            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:bg-gray-800 dark:border-gray-600 dark:focus:ring-indigo-500 dark:focus:border-indigo-500">
    </div>
    <div>
        <label for="age" class="block text-sm font-medium">Age</label>
        <input type="text" value="{{$breeding->age}}" name="age" id="age"
            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:bg-gray-800 dark:border-gray-600 dark:focus:ring-indigo-500 dark:focus:border-indigo-500">
    </div>
    <div>
        <label for="incubationTemperature" class="block text-sm font-medium">Incubation Temperature</label>
        <input type="number" value="{{$breeding->temp}}" name="temp" id="incubationTemperature"
            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:bg-gray-800 dark:border-gray-600 dark:focus:ring-indigo-500 dark:focus:border-indigo-500">
    </div>
...
<div class="mb-4">
                ...
                <select name="genetic_details" id="genetic_details" class="mt-1 dark:text-gray-200 focus:ring-indigo-500 dark:bg-gray-800 p-2 border  dark:bg-gray-800 dark:border-gray-600 dark:focus:ring-indigo-500 dark:focus:border-indigo-500 rounded-md w-full">
                    <option value="{{$breeding->genetic_details}}">{{$breeding->genetic_details}}</option>
    ...
    <div>
        ...
        <textarea value="{{$breeding->remarks}}" name="remarks" id="remarks" rows="3"
            ...
            // Add more conditions based on other animal types
        }
